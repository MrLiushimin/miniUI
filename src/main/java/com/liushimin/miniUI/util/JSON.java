...
//		deserializer.use("birthday", new DateTransformer("yyyy-MM-dd'T'HH:mm:ss"));
//		deserializer.use(String.class, new DateTransformer("yyyy-MM-dd'T'HH:mm:ss"));
	...
	public static Object decode(String json) {
		if (StringUtil.isNullOrEmpty(json)) return "";
		JSONDeserializer deserializer = new JSONDeserializer();
//		deserializer.use("values.birthday", new DateTransformer("yyyy-MM-dd'T'HH:mm:ss"));
//		deserializer.use("createtime", new DateTransformer("yyyy-MM-dd'T'HH:mm:ss"));
//		deserializer.use(String.class, new DateTransformer("yyyy-MM-dd'T'HH:mm:ss"));
//		deserializer.use(Date.class, new DateTransformer("yyyy-MM-dd'T'HH:mm:ss"));
//		deserializer.use(Timestamp.class, new DateTransformer("yyyy-MM-dd'T'HH:mm:ss"));
		Object obj = deserializer.deserialize(json);
		if(obj != null && obj.getClass() == String.class){
			return decode(obj.toString());
		}		
